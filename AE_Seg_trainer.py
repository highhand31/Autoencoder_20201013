...
def get_AE_settings_of_AE_SEG(height=128,width=128,p=0.5):
    ae_var = dict()
    # ----model init
    # ae_var['infer_method'] = "AE_pooling_net_V7"  # "AE_pooling_net_V7"  # "AE_JNet"#"AE_transpose_4layer",mit_b0
    ae_var['model_name'] = "type_5_7"
    kernel_list = [7, 5, 5, 5, 3, 3, 3]
    filter_list = [16, 24, 32, 40, 48, 56, 64]
    stride_list = [2] * 7
    multi_ratio = 1.5
...
def get_SEG_settings_of_AE_SEG(height=128,width=128,p=0.5):
    seg_var = dict()
    hole_dict = dict(
        defect_num=1,
        defect_png_source=[
...
def get_AE_SEG_commom_arg(**kwargs):
    para_dict = dict()
    para_dict['model_name'] = "type_5_1"
    para_dict['preprocess_dict'] = {'ct_ratio': 1, 'bias': 0.5, 'br_ratio': 0}
    # {'ct_ratio': 1.48497, 'bias': 0.25, 'br_ratio': 0.25098}
    # #default {'ct_ratio': 1, 'bias': 0.5, 'br_ratio': 0}
    ...
    # para_dict['use_previous_settings'] = False
    para_dict['encript_flag'] = True
    para_dict['print_out'] = False
    para_dict['show_parameters'] = False
...
def get_template_config():
    ae_var = get_AE_settings_of_AE_SEG()
    seg_var = get_SEG_settings_of_AE_SEG()
    return get_AE_SEG_commom_arg(ae_var=ae_var, seg_var=seg_var)
...
def get_user_config():
    ...
    ae_var = dict(
        train_img_dir=[
            r"D:\dataset\optotech\silicon_division\PDAP\PD_55077\ok_parts_train",
        ],
        test_img_dir=[
            r"D:\dataset\optotech\silicon_division\PDAP\PD_55077\ok_parts_test",
        ],
...
if __name__ == "__main__":
    ...
    AE_Seg_train = AE_Seg(template_config,user_dict=user_config)
