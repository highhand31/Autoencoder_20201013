...
def get_AE_arg():
    ...
    ae_var['setting_dict'] = {'rdm_shift': 0.03, 'rdm_angle': 3, 'rdm_patch': rdm_patch}
    ae_var['aug_times'] = 2
...
def get_SEG_arg():
    ...
    seg_var['id2class_name'] = r"D:\dataset\optotech\silicon_division\PDAP\20220517_PDAP_環光0.0.2Data\classnames.txt"
    seg_var['train_img_seg_dir'] = [
        r"D:\dataset\optotech\silicon_division\PDAP\20220517_PDAP_環光0.0.2Data\刮傷資料\train",
        r"D:\dataset\optotech\silicon_division\PDAP\20220517_PDAP_環光0.0.2Data\藥水殘資料\train",
                                    ]
    seg_var['test_img_seg_dir'] = [
        r"D:\dataset\optotech\silicon_division\PDAP\20220517_PDAP_環光0.0.2Data\刮傷資料\test",
        r"D:\dataset\optotech\silicon_division\PDAP\20220517_PDAP_環光0.0.2Data\藥水殘資料\test",
                                   ]
    seg_var['predict_img_dir'] = None#[r'D:\dataset\optotech\silicon_division\PDAP\破洞_金顆粒_particle\NG(多區NG-輕嚴重)_20220504\selected']
...
if __name__ == "__main__":
    ...
    para_dict['save_dir'] = r"D:\code\model_saver\AE_Seg_107"
