...
# Functions
##
def get_img_2(path,size=(192,192), norm_exposure=False,gray=True):
...
def earth_movers_distance(path_a, path_b):
  ...
  @returns:
    TODO
  '''
  img_a = get_img_2(path_a, norm_exposure=True)
  img_b = get_img_2(path_b, norm_exposure=True)
...
def structural_sim(path_a, path_b):
  ...
  '''
  size = (192,192)
  img_a = get_img_2(path_a,size=size)
  img_b = get_img_2(path_b,size=size)
...
if __name__ == '__main__':
  img_a = r"C:\Users\User\Desktop\file_test\database\only_OK_2\L1_OK\14.JPG"
  img_b = r"C:\Users\User\Desktop\file_test\database\only_OK_2\L1_OK\19.JPG"
  # get the similarity values
  s,diff = structural_sim(img_a, img_b)
  print(s)
  # print(diff.dtype)
  # print(diff.shape)
  # diff *= 255
